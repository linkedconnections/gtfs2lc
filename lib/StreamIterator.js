...
var StreamIterator = function (stream, test) {
...
StreamIterator.prototype.next = function (callback) {
   return new Promise(async (resolve, reject) => {
      ...
      // This only fails on the tests for some reason and the hack makes real data to crash :(
      // We really need to reactor all this code.
      if (this._test) {
