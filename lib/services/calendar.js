...
const Transform = require('stream').Transform,
      ...
      { format, eachDayOfInterval } = require('date-fns');

var CalendarToServices = function (calendarDatesStream, isTest) {
  Transform.call(this, {objectMode : true});
  this._calendarDatesIterator = new StreamIterator(calendarDatesStream, isTest);
};
