              ...
              self._stopsdb.get(connectionRule['departure_stop'], function (error, departureStop) {
                if (!error) {
                  self._stopsdb.get(connectionRule['arrival_stop'], function (error, arrivalStop) {
                      if (!error) {
                        self._stoptimeoverridesdb.get(trip['trip_id'] + "#" + trip['service_id'] + "#" + connectionRule['stop_sequence'], function (error, departureOverride) {
                          self._stoptimeoverridesdb.get(trip['trip_id'] + "#" + trip['service_id'] + "#" + (parseInt(connectionRule['stop_sequence']) + 1), function (error, arrivalOverride) {
                            ...
                            for (var i in service) {
                              ...
                              if (departureOverride !== undefined)
                                connection['departureStop'] = {
                                  ...
                                  'gtfs:stop': departureOverride['stop_id'].trim(),
                              ...
                              if (arrivalOverride !== undefined)
                                connection['arrivalStop'] = {
                                  ...
                                  'gtfs:stop': arrivalOverride['stop_id'].trim(),
