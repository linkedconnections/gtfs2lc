...
class ConnectionsBuilder extends Transform {
  constructor(tripsdb, servicesdb, routesdb) {
  ...
  async _transform(connectionRule, encoding, done) {
    ...
    try {
      let firstDepartureDFM = moment.duration(connectionRule['first_departure_dfm']);
