...
URIStrategy.prototype.getId = function (connection) {
  return this._baseUris.connections + encodeURIComponent((connection.departureTime.unix() * 1000) + connection.departureStop + connection.trip.trip_id);
};
...
URIStrategy.prototype.getTripId = function (connection) {
  return this._baseUris.trips + encodeURIComponent(connection.trip.trip_id);
}

URIStrategy.prototype.getRouteId = function (connection) {
  return this._baseUris.routes + encodeURIComponent(connection.trip.route_id);
}
