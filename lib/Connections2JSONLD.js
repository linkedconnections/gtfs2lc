...
Connections2JSONLD.prototype._transform = function (connection, encoding, done) {
  var id = this._baseUris.connections + connection.departureTime + connection.departureStop + connection.trip;
    ...
    "@id" : id,
    "@type" : "Connection",
    "departureStop" : this._baseUris.stops + connection.departureStop,
    "arrivalStop" : this._baseUris.stops + connection.arrivalStop,
    "departureTime" : connection.departureTime.toISOString(),
    "arrivalTime" : connection.arrivalTime.toISOString(),
    "gtfs:trip" : this._baseUris.trips + connection.trip,
    "gtfs:route" : this._baseUris.routes + connection.route
  });
};
